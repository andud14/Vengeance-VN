...
define config.name = _("Vengeance")
...
define gui.about = _p("""
Не уверен, что это вообще кто-то будет читать, но все равно напишу. Над Vengeance мы старались очень долго, а поэтому нам очень важно мнение насчет нашей игры. Это наш первый проект, и мы пытались сделать его максимально интересным.
""")
...
define config.main_menu_music = "music/Vengeance Theme.ogg"
...
define config.save_directory = "Vengeance-1591179993"
