...
screen main_menu():
    ...
    imagemap: 
            ground "gui/menu/menu.png"   
            hover "gui/menu/menu_b.png" 
            alpha True 

            hotspot (803, 656, 318, 49) action Start() 
            hotspot (741, 712, 442, 51) action ShowMenu("load")
            hotspot (820, 833, 284, 47) action ShowMenu("preferences")
            hotspot (851, 776, 224, 49) action ShowMenu("gallery")
            hotspot (763, 890, 400, 54) action Quit(confirm=True)
            hotspot (1717, 1042, 192, 27) action OpenURL("https://vk.com/g9studio")
...
screen about():
    ...
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Спасибо, что играете в нашу игру!")
